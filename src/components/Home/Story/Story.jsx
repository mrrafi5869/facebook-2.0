        ...
        <form onSubmit={handleShareStory} className="flex my-6">
            <div className='mr-3'>
                <label htmlFor="story">
                    ...
                    <img src={user?.uid && user.photoURL} className="h-40 w-[133px] rounded-t-lg" alt="" />
                    <FontAwesomeIcon icon={faPlus} className="bg-blue-500 text-white p-2 rounded-full border-4 absolute border-black bottom-6 left-12"></FontAwesomeIcon>
            ...
            <div className='flex'>
                {
                    stories && stories.map((story, index) => <img key={index} src={story.photo} alt="" className='className=h-40 w-[133px] rounded-lg mr-3'/>)
                }
            </div>
